...
import { registerUser, setAuthData, isAuthenticated, getAuthUser } from "@/lib/auth";
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md glass rounded-[32px] border border-white/10 p-10 shadow-2xl">
        <div className="mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-3">Sign up and start saving personalized analysis chats.</p>
        </div>
