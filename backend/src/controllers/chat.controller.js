...
export const getFullResults = async (req, res) => {
  ...
  const canonicalResult = {
    ...
    growth: hasGrowthWorkspace ? {
      ...
      product: productIntelligence?.productAnalysis || {},
      market: productIntelligence?.marketDiscovery || {},
      audience: productIntelligence?.audienceIntelligence || {},
      competitor: competitorIntelligence?.competitorAnalysis || {},
      intent: competitorIntelligence?.intentPrediction || {},
      positioning: competitorIntelligence?.positioningEngine || {},
      campaign: campaignIntelligence?.campaignGenerator || {},
      channel: campaignIntelligence?.channelRecommendation || {},
