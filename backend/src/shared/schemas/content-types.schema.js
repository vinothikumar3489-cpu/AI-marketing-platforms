...
export const SCHEMA_REGISTRY = {
  ...
  x_post: { schema: twitterPostSchema, normalizer: 'twitterPost' },
  ...
  email_welcome: { schema: emailCopySchema, normalizer: 'emailCopy' },
  email_promotional: { schema: emailCopySchema, normalizer: 'emailCopy' },
  email_follow_up: { schema: emailCopySchema, normalizer: 'emailCopy' },
  email_event_invitation: { schema: emailCopySchema, normalizer: 'emailCopy' },
  email_reengagement: { schema: emailCopySchema, normalizer: 'emailCopy' },
  email_final_cta: { schema: emailCopySchema, normalizer: 'emailCopy' },
