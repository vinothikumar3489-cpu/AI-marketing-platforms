export function normalizeEvidenceResponse(raw) {
  ...
  if (raw.website) {
    evidence.website = {
      ...
      benefitsText: raw.website.benefitsText || [],
      pricingText: raw.website.pricingText || [],
      integrationsList: raw.website.integrationsList || [],
      testimonialsList: raw.website.testimonialsList || [],
      caseStudiesList: raw.website.caseStudiesList || [],
      faqItems: raw.website.faqItems || [],
      tables: raw.website.tables || [],
      lists: raw.website.lists || [],
      navigationLinks: raw.website.navigationLinks || [],
      footerLinks: raw.website.footerLinks || [],
      targetAudienceHints: raw.website.targetAudienceHints || [],
      industryHints: raw.website.industryHints || [],
      pageType: raw.website.pageType || null,
      productName: raw.website.productName || null,
      pageTypes: {
