...
function generateFallbackContentGaps(productName, industry) {
  ...
  if (productLower.includes('canva')) {
    ...
    gaps.push(
      {
        title: `${productName} vs Competitors: Complete Comparison`,
        pageType: 'comparison',
        targetKeyword: `${productName} alternatives`,
        searchVolume: null,
        keywordDifficulty: null,
        intent: 'commercial',
        evidence: 'Generic comparison page',
      ...
      {
        title: `Best ${industry} Tools for ${productName}`,
        pageType: 'landing_page',
        targetKeyword: `best ${industry} tools`,
        searchVolume: null,
        keywordDifficulty: null,
        intent: 'commercial',
        evidence: 'Generic landing page',
        source: 'Generic Seed Generation',
        confidence: 50,
        businessImpact: 'medium',
        priority: 'medium',
