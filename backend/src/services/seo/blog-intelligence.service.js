    ...
    blogIdeas.push(
      {
        ...
        keywordDifficulty: null,
        intent: 'commercial',
        outline: ['Introduction', 'Feature comparison', 'Pricing', 'Pros and cons', 'Verdict'],
        estimatedTrafficPotential: 'medium',
        source: 'Generic Seed Generation',
        confidence: 50,
        evidence: 'Generic comparison blog',
        internalLinkSuggestions: ['Features', 'Pricing'],
        priority: 'high'
      },
      {
        title: `Best ${industry} Tools for ${productName} Users`,
        targetKeyword: `best ${industry} tools`,
        searchVolume: null,
        keywordDifficulty: null,
        intent: 'informational',
        outline: ['Industry overview', 'Top tools', 'Features', 'Selection guide', 'Conclusion'],
        estimatedTrafficPotential: 'medium',
        source: 'Generic Seed Generation',
        confidence: 50,
        evidence: 'Generic industry blog',
        internalLinkSuggestions: ['Features', 'Blog'],
        priority: 'medium'
      }
    );
