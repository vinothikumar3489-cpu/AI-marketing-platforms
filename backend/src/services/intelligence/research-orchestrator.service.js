...
import { getSerpCompetitors } from '../../providers/dataforseo.service.js';
...
export async function collectResearchData({ websiteUrl, productName, companyName }) {
  ...
  try {
    ...
    console.log('website:', result.websiteContent ? 'Γ£ô (title: ' + (result.websiteContent.title || result.websiteContent.metadata?.title || 'N/A') + ')' : 'Γ£ù null');
    console.log('technical:', result.technical ? 'Γ£ô (performanceScore: ' + result.technical.performanceScore + ')' : 'Γ£ù null');
