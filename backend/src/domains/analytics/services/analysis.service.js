...
export const generateAnalysis = async ({ manualData = {}, scrapedData = {}, evidenceContext = "" } = {}) => {
  ...
  const analysisSchema = z.object({
    ...
    features: z.array(evidenceItemSchema).optional(),
    benefits: z.array(evidenceItemSchema).optional(),
    painPoints: z.array(evidenceItemSchema).optional(),
    buyerPersonas: z.array(evidenceItemSchema).optional(),
    targetUsers: z.array(evidenceItemSchema).optional(),
    competitorTypes: z.array(evidenceItemSchema).optional(),
    competitors: z.array(evidenceItemSchema).optional(),
    marketingAngles: z.array(evidenceItemSchema).optional(),
    pricingPosition: z.string().nullable().optional(),
    marketMaturity: z.string().nullable().optional(),
    seoOpportunities: z.array(evidenceItemSchema).optional(),
    campaignIdeas: z.array(evidenceItemSchema).optional(),
    ...
    useCases: z.array(evidenceItemSchema).optional(),
    customerSegments: z.array(evidenceItemSchema).optional(),
    testimonials: z.array(evidenceItemSchema).optional(),
    caseStudies: z.array(evidenceItemSchema).optional(),
    technologyStack: z.array(evidenceItemSchema).optional(),
    schemaOrg: z.array(evidenceItemSchema).optional(),
    faq: z.array(evidenceItemSchema).optional(),
    resources: z.array(evidenceItemSchema).optional(),
  });
