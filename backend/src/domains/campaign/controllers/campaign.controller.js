    ...
    await prisma.automationLog.create({
      data: {
        ...
        metadata: {
          ...
          hasMarketingStrategy: !!campaignData.marketingStrategy,
          hasEmailCampaigns: !!(campaignData.emailCampaigns?.length > 0),
          hasAds: !!(campaignData.ads?.length > 0),
          hasLandingPages: !!(campaignData.landingPages?.length > 0),
          hasSocialPosts: !!(campaignData.socialPosts?.length > 0),
          hasCreativeAngles: !!(campaignData.creativeAngles?.length > 0),
          hasBudget: !!campaignData.budget,
          hasForecast: !!campaignData.forecast,
          hasRoi: !!campaignData.roi,
