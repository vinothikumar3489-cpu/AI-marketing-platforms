...
export const runProductAnalysis = async (req, res) => {
  ...
  try {
    ...
    const completeAnalysis = {
      ...
      testimonials: analysisData?.testimonials || [],
      caseStudies: analysisData?.caseStudies || [],
      technologyStack: analysisData?.technologyStack || [],
      schemaOrg: analysisData?.schemaOrg || [],
    ...
    const responseAnalysis = {
      ...
      customerSegments: saved.customerSegments || [],
      testimonials: saved.testimonials || [],
      caseStudies: saved.caseStudies || [],
      technologyStack: saved.technologyStack || [],
      schemaOrg: saved.schemaOrg || [],
      faq: saved.faq || [],
